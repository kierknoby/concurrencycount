...
- Run Light, Medium and Heavy Demo profiles from the **Load** dropdown and confirm they request exactly 1,000, 5,000 and 20,000 calls over one day. Select Heavy, press **Randomise**, and confirm Heavy remains selected. Reload the module and confirm the GUI scenario is not restored.
