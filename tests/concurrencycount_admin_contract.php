...
admin_contract_assert(strpos($view, 'id="cc-report-filter"') !== false && strpos($javascript, "$('#cc-report-filter').val(criteria && criteria.filter") !== false, 'Edit Report must visibly restore the endpoint filter criterion');
...
admin_contract_assert(strpos($javascript, 'if (!preserveDisplayedResult)') !== false && strpos($javascript, 'if (!wizardEditingExisting) setStatus') !== false, 'Opening or cancelling Edit Report must preserve the displayed report');
