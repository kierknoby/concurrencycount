...
admin_contract_assert(strpos($view, 'name="cc-demo-load"') !== false && strpos($view, "'medium' ? ' active'") !== false && strpos($view, 'id="cc-demo-randomise"') !== false && strpos($view, 'id="cc-demo-save"') !== false, 'Demo must expose explicit load, Randomise and Save selection controls with deterministic Medium default');
