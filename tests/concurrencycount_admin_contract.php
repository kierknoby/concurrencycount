...
admin_contract_assert(strpos($historicalExportJavascript, 'image/svg+xml') !== false && strpos($historicalExportJavascript, '<style>') !== false && strpos($historicalExportJavascript, 'cc-historical-svg-series') !== false, 'SVG export must remain self-contained vector markup');
