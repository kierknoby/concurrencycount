...
admin_contract_assert(strpos($css, '.cc-demo-load.cc-demo-load-selected') !== false && strpos($css, '.cc-demo-load.cc-demo-load-unselected') !== false && strpos($javascript, "toggleClass('active cc-demo-load-selected'") !== false, 'Demo load state must use scoped explicit selected/unselected styling');
...
admin_contract_assert(strpos($javascript, 'class="cc-report-tab-handle" draggable="true"') !== false && strpos($javascript, 'cc-report-tab-left') === false && strpos($javascript, "off('dragstart.ccTabs', '.cc-report-tab-handle')") !== false && strpos($javascript, 'CCHistoricalReportOrder.createSaver') !== false && strpos($javascript, "e.key === 'ArrowLeft'") !== false && strpos($historicalReportsService, 'function reorder(') !== false, 'Historic Report tabs must use handle-only drag/keyboard reordering with serialized persistence');
