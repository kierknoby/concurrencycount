...
admin_contract_assert(strpos($demoSource, 'requireDemoStatementTimeoutSupport') < strpos($demoSource, 'verifyCleanupAccessPath()'), 'Demo must reject databases without native statement timeout support before recovery or CDR work');
