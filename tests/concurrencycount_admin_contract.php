...
admin_contract_assert(strpos($view, 'max="2147483647"') === false && substr_count($view, 'min="1"') >= 2, 'Minimum concurrency must be positive without presenting an implementation maximum');
...
admin_contract_assert(strpos($historicalSvgJavascript, 'function coloursForInventory(names)') !== false && strpos($historicalSvgJavascript, 'index * 137.507764') !== false && strpos($liveJavascript, 'HistoricalSvgChart.coloursForInventory(names)') !== false && strpos($liveJavascript, 'color: inventoryColours[name]') !== false, 'Series colours must be distributed from the complete stable inventory without finite-palette cycling');
...
admin_contract_assert(strpos($liveJavascript, 'selection.initial(names, historicalSeries.series)') !== false && strpos($liveJavascript, 'selection.toggle(historicalSelectedSeries') !== false && strpos($liveJavascript, 'selection.all(names)') !== false, 'Historical series selection must preserve one default and support independent toggle and Select All state');
