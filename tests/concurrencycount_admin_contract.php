...
admin_contract_assert(strpos($historicalSvgJavascript, 'var WIDTH = 1600, HEIGHT = 300, MINIMUM_RUN_WIDTH = 24') !== false && strpos($historicalSvgJavascript, 'viewBox="0 0 ') !== false && strpos($historicalSvgJavascript, 'preserveAspectRatio="xMidYMid meet"') !== false, 'Historical SVG generation must use one fixed logical coordinate system');
admin_contract_assert(strpos($historicalSvgJavascript, 'getBoundingClientRect') > strpos($historicalSvgJavascript, 'HistoricalSvgChart.prototype.pointerTimestamp') && substr_count($historicalSvgJavascript, 'getBoundingClientRect') === 2, 'DOM measurement must be confined to interaction-time overlay mapping');
