...
admin_contract_assert(strpos($javascript, 'draggable="true"') !== false && strpos($javascript, 'reorderhistoricalreports') !== false && strpos($javascript, 'cc-report-tab-left') !== false && strpos($historicalReportsService, 'function reorder(') !== false, 'Historic Report tabs must support persistent drag and accessible button reordering');
