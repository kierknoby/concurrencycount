...
admin_contract_assert(strpos($css, '.cc-occurrence > .panel-heading') !== false && strpos($css, 'background: #fff') !== false, 'Occurrence navigation rows must explicitly retain a neutral white background');
