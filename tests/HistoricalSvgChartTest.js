...
assert(initialButtons.selectAllActive && !initialButtons.unselectAllActive && Object.keys(initialButtons.series).every(function (name) { return initialButtons.series[name].buttonClass === 'btn-primary' && initialButtons.series[name].ariaPressed === 'true'; }), 'All-selected state activates Select All and every series');
