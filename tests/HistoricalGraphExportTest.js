...
const graphMarkup = '<svg id="cc-historical-chart" viewBox="0 0 1000 220"><path class="cc-historical-svg-series" d="' + chart.paths[0] + '"/><g class="cc-historical-svg-tooltip" style="display:none"><text>tooltip</text></g></svg>';
