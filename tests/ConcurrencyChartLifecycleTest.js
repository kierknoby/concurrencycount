...
assert(presentation.layout(400, false).inset === 0 && presentation.layout(400, false).height === 400, 'Short windowed viewports consume the complete available height');
assert(presentation.layout(900, false).inset === 0 && presentation.layout(900, false).height === 900, 'Windowed Live Wall consumes the complete viewport');
...
assert(presentation.layout(1800, false).inset === 0 && presentation.layout(1800, false).height === 1800, 'Tall windowed viewports remain edge-to-edge');
