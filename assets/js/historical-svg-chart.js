(function (root, factory) {
	...
	HistoricalSvgChart.prototype.candidate = function (event) { if (!this.chart) return null; var coordinates = this.pointerCoordinates(event), candidate = nearestSeriesPoint(this.chart, coordinates.x, coordinates.y); return candidate && Number(candidate.point.value) > 0 && candidate.distance <= 10 ? candidate : null; };
