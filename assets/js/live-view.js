...
(function ($) {
	...
	function renderSnapshot(data) {
		...
		$('#cc-live-updated-time').attr('datetime', data.generated_at).text(window.CCDateFormat.localDateTime(data.generated_ts * 1000));
	...
	function renderLiveWall(data) {
		...
		$('#cc-wall-updated').text('Last successful update: ' + window.CCDateFormat.localDateTime(data.generated_ts * 1000));
